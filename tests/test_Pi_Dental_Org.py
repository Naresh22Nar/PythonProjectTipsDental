...
@pytest.mark.parametrize('User_Credentials', User_Credentials)
def test_dental_Org_Employee_child(playwright: Playwright,User_Credentials, browser_Instance):
    User_Email = User_Credentials["userEmail"]
    user_Password= User_Credentials["userPassword"]
    org_Ph_Name= User_Credentials["orgPhName"]
    org_Ph_Bp=User_Credentials["orgPhBp"]
...
@pytest.mark.parametrize('User_Credentials', User_Credentials)
def test_dental_Org_Employee_Spouse(playwright: Playwright,User_Credentials, browser_Instance):
    User_Email = User_Credentials["userEmail"]
    user_Password= User_Credentials["userPassword"]
    org_Ph_Name= User_Credentials["orgPhName"]
    org_Ph_Bp=User_Credentials["orgPhBp"]
